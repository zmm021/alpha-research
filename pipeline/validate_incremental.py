...
DEFAULT_OUTPUT_MACRO_DEBUG = "pipeline/macro_debug.csv"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--macro-debug-out", default=DEFAULT_OUTPUT_MACRO_DEBUG)
...
def main() -> None:
    ...
    run_validation(
        ...
        macro_debug_out=args.macro_debug_out,
        tol=args.tol,
    )
